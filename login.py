...
# --- NEW: Login Logic ---
# The st.login function will return True if the user is authenticated, and False otherwise.
if st.login(st.secrets["credentials"]):

    # --- Streamlit App UI (This code runs only after a successful login) ---
